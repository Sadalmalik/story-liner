...
namespace Self.Story
{
	...
	public class Chapter : ScriptableObject, ISerializationCallbackReceiver
	{
		...
		public void OnAfterDeserialize()
		{
			...
			DeserializeVariableData(variablesContainer.serializedStringVariables,
				ref variablesContainer.stringVariables);
		}
		...
		private void DeserializeVariableData<T, U>(List<U> serializedData, ref Dictionary<string, T> deserializedData)
			where U : VariableData<T>, new()
		{
		...
		private void SerializeVariableData<T, U>(Dictionary<string, T> dataToSerialize, ref List<U> serializedData)
			where U : VariableData<T>, new()
		{

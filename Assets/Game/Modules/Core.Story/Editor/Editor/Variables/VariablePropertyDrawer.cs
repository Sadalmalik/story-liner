		...
		private Rect DrawPropertyField(SerializedProperty property, Rect position)
		{
			...
			switch (property.propertyType)
			{
				case SerializedPropertyType.Integer:
					...
					{
						if (property.displayName == property.serializedObject.FindProperty(nameof(IntVariable.value))
							    .displayName)
						{
				...
				case SerializedPropertyType.Float:
					...
					{
						if (property.displayName == property.serializedObject.FindProperty(nameof(FloatVariable.value))
							    .displayName)
						{
				...
				default:
					EditorGUI.LabelField(newPos,
						$"[{nameof(VariablePropertyDrawer)}.{nameof(DrawPropertyField)}] Not implemented for '{property.propertyType}'");
					break;
			}
